...
class _NewArticle extends State<ArticleEcran> {
  ...
  Future<Beanarticledatahistory> getmobilearticleinformationbyidart() async {
    final url = Uri.parse(
        '${dotenv.env['URL']}backendcommerce/getmobilearticleinformationbyidart');
    ...
    if (response.statusCode == 200) {
      return Beanarticledatahistory.fromJson(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                    ...
                                    width: 120,
                                    child: Visibility(
                                      visible: _achatController.taskData
                                                  .indexWhere((element) =>
                                                      element.idart == idart) >
                                              -1
                                          ? false
                                      ...
                                      child: Container(
                                        ...
                                        child: TextButton(
                                          ...
                                          child: Text(article.nombrearticle > 0
                                              ? 'Acheter'
                                              : 'Epuisé'),
                                        ),
                                      ),
                                ...
                                Positioned(
                                    right: ((_achatController.taskData
                                                    .indexWhere((element) =>
                                                        element.idart ==
                                                        idart) >
                                                -1) &&
                                            (article.nombrearticle -
                                                    _achatController.taskData
                                                        .map((element) =>
                                                            element.idart ==
                                                                    idart
                                                                ? 1
                                ...
                                Positioned(
                                    right: _achatController.taskData.indexWhere(
                                                (element) =>
                                                    element.idart == idart) >
                                            -1
                                        ? 60
                                    ...
                                    child: Visibility(
                                      ...
                                      child: Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(
                                            '${_achatController.taskData.isNotEmpty ? _achatController.taskData.map((element) => element.idart == idart ? 1 : 0).reduce((value, element) => value + element) : 0}',
                              ...
                              children: [
                                Container(
                                    width: MediaQuery.of(context)
                                        .size
                                        .width, // 250
                                    height: ((article.trackVetement == 4) ||
                                            (article.taille == 1))
                                        ? 440
                                        : 250,
                                    child: CarouselSlider.builder(
                                      ...
                                      itemBuilder: (BuildContext context,
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                              "https://firebasestorage.googleapis.com/v0/b/gestionpanneaux.appspot.com/o/${article.images[itemIndex].lienweb}?alt=media",
                                          imageBuilder:
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        article.entreprise.toUpperCase(),
                                        style: const TextStyle(
                                            fontSize: 15,
                                ...
                                Container(
                                  ...
                                  width: MediaQuery.of(context).size.width,
                                  child: Text(
                                    '${formatPrice(article.reduction > 0 ? (article.modepourcentage == 1 ? (article.prix - ((article.prix * article.reduction) / 100)).toInt() : article.prix) : article.prix)} FCFA',
                                    style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20,
                                      /*shadows: [
                                        ...
                                        Shadow(
                                          color: Colors.brown, // Choose the color of the second shadow
                                          blurRadius: 4.0, // Adjust the blur radius for the second shadow effect
                                          offset: Offset(-2.0, 2.0), // Set the horizontal and vertical offset for the second shadow
                                        )
                                      ]*/
                                    ),
                                  ),
                                ...
                                Container(
                                  ...
                                  child: ((article.reduction > 0) &&
                                          (article.modepourcentage == 1))
                                      ? Row(
                                          children: [
                                            Text(
                                      ...
                                      : ((article.reduction > 0) &&
                                              (article.modepourcentage == 0))
                                          ? Text(
                                              '${article.reduction} article(s) à partir de ${formatPrice(article.prixpromo)} FCFA',
                                              style: const TextStyle(
                                                  color: promotioncolor,
                                                  fontWeight: FontWeight.bold))
                                          : Container(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        '${article.nombrearticle - (_achatController.taskData.isNotEmpty ? _achatController.taskData.map((element) => element.idart == idart ? 1 : 0).reduce((value, element) => value + element) : 0)} article(s) restant(s)',
                                        style: TextStyle(
                                          fontSize: 15,
                                          color: (article.nombrearticle -
                                                      (_achatController.taskData
